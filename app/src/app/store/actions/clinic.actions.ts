...
export const createClinic = createAction(CLINIC_ACTION_TYPES.CREATE_CLINIC, props<{ clinic: IClinic, notify?: boolean }>());
...
export const updateClinic = createAction(
  CLINIC_ACTION_TYPES.UPDATE_CLINIC, props<{ clinicId: string, clinic: IClinic, notify?: boolean }>());
export const putClinic = createAction(CLINIC_ACTION_TYPES.PUT_CLINIC, props<{ clinicId: string, clinic: IClinic }>());
export const putClinics = createAction(CLINIC_ACTION_TYPES.PUT_CLINICS, props<{ clinics: IClinic[] }>());
