...
export const putRequiredAction = createAction(
  REQUIRED_ACTIONS_ACTION_TYPES.PUT_REQUIRED_ACTION, props<{actionId: string, action: IRequiredAction}>());
export const putRequiredActions = createAction(REQUIRED_ACTIONS_ACTION_TYPES.PUT_REQUIRED_ACTIONS, props<{actions: IRequiredAction[]}>());
