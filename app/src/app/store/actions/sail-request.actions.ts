...
export const createSailRequest = createAction(SAIL_REQUEST_ACTION_TYPES.CREATE, props<{ sailRequest: ISailRequest }>());
...
export const putSailRequest = createAction(SAIL_REQUEST_ACTION_TYPES.PUT_ONE, props<{ id: string, sailRequest: ISailRequest }>());
export const putSailRequests = createAction(SAIL_REQUEST_ACTION_TYPES.PUT_MANY, props<{ sailRequests: ISailRequest[] }>());
...
export const updateSailRequest = createAction(SAIL_REQUEST_ACTION_TYPES.UPDATE, props<{ id: string, sailRequest: ISailRequest}>());
